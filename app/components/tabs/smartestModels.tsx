...
import { SmrtestModel } from "@/app/types/model"
    ...
    return (
        <>
            ...
            {models.map((m: any, i: number) => (
                <div key={m.rank} className="group flex flex-col gap-2 bg-white border rounded-lg hover:border-primary/50 hover:shadow-sm transition-all p-4 mb-2">
